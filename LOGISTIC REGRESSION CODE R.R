...
setwd("D:\\R CLASS\\Linear Case Study\\Proactive Attrition Management-Logistic Regression Case Study")
...
dataAll = read.csv("Proactive Attrition Management-Logistic Regression Case Study.csv", header = TRUE) #COMPLETE DATASET
View(dataAll)

str(dataAll)
prop.table(table(dataAll$CHURN))

#DROPPING VARIABLES WITH NO IMPORTANCE TO THIS PROBLEM
